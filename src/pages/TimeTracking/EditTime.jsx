...
// Rendered with key={record?.id} from the parent so state resets per record.
export default function EditTime({ open, record, onSave, onCancel }) {
        ...
        <div className="px-6 pt-5 pb-4 flex items-center justify-between border-b border-[#eaf3f8]">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-[#eaf3f8] flex items-center justify-center">
              <FiClock className="w-4.5 h-4.5 text-[#5b9ab5]" />
            </div>
            <div>
